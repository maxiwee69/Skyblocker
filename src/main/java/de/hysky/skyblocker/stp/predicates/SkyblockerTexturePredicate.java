 ...
 */
public sealed interface SkyblockerTexturePredicate extends Predicate<ItemStack> permits AndPredicate, ApiIdPredicate, BoundingBoxPredicate, CustomDataPredicate, HeldByArmorStandPredicate, InsideScreenPredicate, LocationPredicate, NotPredicate, OrPredicate, PetInfoPredicate, ProfileComponentPredicate, RegexPredicate, StringPredicate {
